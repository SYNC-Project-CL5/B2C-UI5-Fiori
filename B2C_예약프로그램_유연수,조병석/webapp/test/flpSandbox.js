		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "타이어 온라인 주문",
									"targetURL": "#synceareserve2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceareserve2-display": {
								"semanticObject": "synceareserve2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.reserve2",
									"url": sap.ui.require.toUrl("sync/ea/reserve2")
								}
							}
						}
					}
